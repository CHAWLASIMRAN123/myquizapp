...
import UIKit
    ...
    @IBOutlet var mulLabel1: UILabel!
    
    @IBOutlet var mulLabel2: UILabel!
    
    @IBOutlet var mulLabel3: UILabel!
    
    @IBOutlet var mulLabel4: UILabel!
    ...
    override func viewDidLoad() {
        ...
        func updateMultipleStack(using answers: [Answer]) {
            ...
            mulLabel1.text = answers[0].text
            mulLabel2.text = answers[1].text
            mulLabel3.text = answers[2].text
            mulLabel4.text = answers[3].text
